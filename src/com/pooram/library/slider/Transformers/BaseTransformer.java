package com.pooram.library.slider.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.pooram.library.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.pooram.library.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.pooram.library.slider.Animations.BaseAnimationInterface}
 * work.
 *
