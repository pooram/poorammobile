package com.pooram.library.slider;
...
import com.pooram.library.slider.Animations.BaseAnimationInterface;
import com.pooram.library.slider.Indicators.PagerIndicator;
import com.pooram.library.slider.SliderTypes.BaseSliderView;
import com.pooram.library.slider.Transformers.AccordionTransformer;
import com.pooram.library.slider.Transformers.BaseTransformer;
import com.pooram.library.slider.Transformers.DefaultTransformer;
import com.pooram.library.slider.Tricks.FixedSpeedScroller;
import com.pooram.library.slider.Tricks.InfinitePagerAdapter;
import com.pooram.library.slider.Tricks.InfiniteViewPager;
import com.pooram.library.slider.Tricks.ViewPagerEx;

/**
 * SliderLayout is compound layout. This is combined with
 * {@link com.pooram.library.slider.Indicators.PagerIndicator} and
 * {@link com.pooram.library.slider.Tricks.ViewPagerEx} .
 * 
...
public class SliderLayout extends RelativeLayout {
	...
	/**
	 * {@link com.pooram.library.slider.Tricks.ViewPagerEx} indicator.
	 */
	...
	/**
	 * If {@link com.pooram.library.slider.Tricks.ViewPagerEx} is Cycling
	 */
	...
	/**
	 * {@link com.pooram.library.slider.Tricks.ViewPagerEx} transformer time
	 * span.
	 */
	...
	/**
	 * Visibility of
	 * {@link com.pooram.library.slider.Indicators.PagerIndicator}
	 */
	private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

	/**
	 * {@link com.pooram.library.slider.Tricks.ViewPagerEx} 's transformer
	 */
	private BaseTransformer mViewPagerTransformer;

	/**
	 * @see com.pooram.library.slider.Animations.BaseAnimationInterface
	 */
	private BaseAnimationInterface mCustomAnimation;

	/**
	 * {@link com.pooram.library.slider.Indicators.PagerIndicator} shape, rect
	 * or oval.
	 */
	...
	public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		mTransformerSpan = attributes.getInteger(
				R.styleable.SliderLayout_pager_animation_span, 1100);
	 ...
	 * details in
	 * {@link com.pooram.library.slider.Animations.BaseAnimationInterface},
	 * and you can see a example in
	 * {@link com.pooram.library.slider.Animations.DescriptionAnimation}
	 * 
	 * @param animation
	 */
	...
	/**
	 * get the {@link com.pooram.library.slider.Indicators.PagerIndicator}
