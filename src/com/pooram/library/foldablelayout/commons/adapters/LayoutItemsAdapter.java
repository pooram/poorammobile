package com.pooram.library.foldablelayout.commons.adapters;
...
public abstract class LayoutItemsAdapter<T> extends ItemsAdapter<T> {
     ...
     */
    @SuppressLint("NewApi") protected void addItemsTo(ViewGroup layout) {
     ...
     */
    @SuppressLint("NewApi") protected void recycleAllFrom(ViewGroup layout) {
