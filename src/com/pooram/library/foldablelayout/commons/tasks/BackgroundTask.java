package com.pooram.library.foldablelayout.commons.tasks;
...
public abstract class BackgroundTask<P> {
    ...
    @SuppressLint("NewApi") public void exec() {
        mTask = new ATask();
    ...
    @SuppressLint("NewApi") private class ATask extends AsyncTask<Void, Void, Void> {
